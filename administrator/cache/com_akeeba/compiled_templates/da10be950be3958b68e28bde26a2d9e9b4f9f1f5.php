<?php /* C:\OSPanel\domains\paragraf\administrator\components\com_akeeba\ViewTemplates\ControlPanel\footer.blade.php */ ?>
<?php
/**
...
<div class="row-fluid footer akeebabackup-footer">
	<div class="span12">
		<p style="height: 6em">
			<?php echo \JText::sprintf('Copyright &copy;2006-%s <a href="https://www.akeeba.com">Akeeba Ltd</a>. All Rights Reserved.', date('Y')); ?>
			<br/>
