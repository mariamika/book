<?php /* C:\OSPanel\domains\paragraf\administrator\components\com_akeeba\ViewTemplates\Backup\default.blade.php */ ?>
<?php
/**
...
<div id="backup-setup" class="akeeba-panel--primary">
	...
	<div id="akeeba-fatal-outputdirectory" class="akeeba-block--failure">
		...
		<p>
			<?php echo \JText::sprintf('COM_AKEEBA_BACKUP_ERROR_UNWRITABLEOUTPUT_COMMON', 'index.php?option=com_akeeba&view=Configuration', 'https://www.akeebabackup.com/warnings/q001.html'); ?>
		</p>
	</div>
	<?php endif; ?>
...
<div id="backup-progress-pane" style="display: none">
    ...
    <div>
        <p>
            <em><?php echo \JText::_('COM_AKEEBA_BACKUP_LBL_UPGRADENAG'); ?></em>
        </p>
    </div>
    <?php endif; ?>
</div>
