<?php /* C:\OSPanel\domains\paragraf\administrator\components\com_akeeba\ViewTemplates\ControlPanel\upgrade.blade.php */ ?>
<?php
/**
...
<div class="akeeba-panel--orange">
    <header class="akeeba-block-header">
        <h3>
            ...
            <?php echo \JText::_('COM_AKEEBA_CONTROLPANEL_HEAD_PROUPSELL'); ?>
        </h3>
    </header>

    <p><?php echo \JText::_('COM_AKEEBA_CONTROLPANEL_HEAD_LBL_PROUPSELL_1'); ?></p>

    <?php if(time() < 1583013600): ?>
        <p class="akeeba-block--info"><?php echo \JText::sprintf('COM_AKEEBA_CONTROLPANEL_HEAD_LBL_DISCOUNT',
            base64_decode('SVdBTlRJVEFMTA==')); ?></p>
    <?php endif; ?>

    <p><?php echo \JText::_('COM_AKEEBA_CONTROLPANEL_HEAD_LBL_PROUPSELL_2'); ?></p>
    ...
    <p>
        ...
        <a href="<?php echo $this->container->template->route('index.php?view=ControlPanel&task=dismissUpsell'); ?>" class="akeeba-btn--ghost--small">
            ...
            <?php echo \JText::_('COM_AKEEBA_CONTROLPANEL_BTN_HIDE'); ?>
        </a>
    </p>
</div>