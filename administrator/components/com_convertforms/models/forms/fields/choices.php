        ...
        $html[] = '
            ...
            <div class="nr-choice-settings">
                ...
                <span style="padding-left:10px;">
                    ...
                    <label title="Calculation values are generally used for calculations. It represents the numerical value of a choice." for="' . $showCalcValuesFieldName . '">Use Calculation Values</label>
                </span>
