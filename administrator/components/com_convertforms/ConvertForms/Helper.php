...
class Helper
{
    ...
    public static function loadassets($frontend = false)
    {
        ...
        if ($frontend)
        {
            ...
            // Load ECMAScript polyfills on Internet Explorer and Edge
            $browser = \NRFramework\WebClient::getBrowser();
            if (in_array($browser['name'], ['ie', 'edge']))
            {
                \JHtml::script('com_convertforms/polyfills.js', ['relative' => true, 'version' => 'auto']);
            }
