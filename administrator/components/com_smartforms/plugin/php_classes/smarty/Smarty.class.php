...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    public function setTemplateDir($template_dir)
    {
        ...
        foreach ((array) $template_dir as $k => $v) {
            $this->template_dir[$k] = preg_replace('#(\w+)(/|\\\\){1,}#', '$1$2', rtrim($v, '/\\')) . '/';
        }
    ...
    public function addTemplateDir($template_dir, $key = null)
    {
        ...
        if (is_array($template_dir)) {
            foreach ($template_dir as $k => $v) {
                $v = preg_replace('#(\w+)(/|\\\\){1,}#', '$1$2', rtrim($v, '/\\')) . '/';
                if (is_int($k)) {
            ...
            $v = preg_replace('#(\w+)(/|\\\\){1,}#', '$1$2', rtrim($template_dir, '/\\')) . '/';
            if ($key !== null) {
    ...
    public function setConfigDir($config_dir)
    {
        ...
        foreach ((array) $config_dir as $k => $v) {
            $this->config_dir[$k] = preg_replace('#(\w+)(/|\\\\){1,}#', '$1$2', rtrim($v, '/\\')) . '/';
        }
    ...
    public function addConfigDir($config_dir, $key = null)
    {
        ...
        if (is_array($config_dir)) {
            ...
            $v = preg_replace('#(\w+)(/|\\\\){1,}#', '$1$2', rtrim($config_dir, '/\\')) . '/';
            if ($key !== null) {
                // override directory at specified index
                $this->config_dir[$key] = rtrim($v, '/\\') . '/';
            } else {
                // append new directory
