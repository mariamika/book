 ...
 * @since		1.6
 */
class JFormFieldModal_SmartFormsContacts extends JFormField
{
    /**
     * The form field type.
     *
     ...
     * @since	1.6
     */
    protected $type = 'Modal_SmartFormsContacts';
    /**
    ...
    protected function getInput()
    {
        ...
        $link = 'index.php?tmpl=component&option=com_smartforms&amp;task=list&id='.$this->id;
