<?php die("Access Denied"); ?>#x#a:2:{s:6:"result";s:28654:"try{function $_(idElement){return document.getElementById(idElement);}
...
jQuery(function(){jQuery('.registrationTestPassword').keyup(function(){registrationTestPassword(this.value);});});}catch(e){console.error('Error in file:http://paragraf/components/com_jshopping/js/functions.js; Error:'+e.message);};";s:6:"output";s:0:"";}