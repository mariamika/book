...
/*
    ...
    public ElementClicked(jQueryElement) {
        ...
        let actionElement = rnJQuery('<div style="z-index: 10005" class="smartFormsActionMenu" ><img id="cloneFormElement" src="' + smartFormsRootPath + 'images/clone.png" title="Clone" /><img id="deleteFormElement" src="' + smartFormsRootPath + 'images/delete.png" title="Delete"/></div>');
        let self = this;
