...
var RedNaoFormBuilder = /** @class */ (function () {
    ...
    RedNaoFormBuilder.prototype.InitializeStepDesigner = function (options) {
        ...
        this.MultipleStepsDesigner.GenerationCompletedCallBack = function () {
            rnJQuery("#redNaoElementlist").find('.step-pane').append('<div class="formelement last" style="height:77px;width:100%"><p style="margin-top: 10px;">Drop new fields here</p></div>');
...
*/
    ...
    RedNaoFormBuilder.prototype.CreateFormPreview = function () {
        ...
        if (this.FormType == 'nor') {
            ...
            form.append('<div class="formelement last" style="clear:both;height:77px;width:100%;"><p style="margin-top: 10px;">Drop new fields here</p></div>');
    ...
    RedNaoFormBuilder.prototype.ElementClicked = function (jQueryElement) {
        ...
        var actionElement = rnJQuery('<div style="z-index: 10005" class="smartFormsActionMenu" ><img id="cloneFormElement" src="' + smartFormsRootPath + 'images/clone.png" title="Clone" /><img id="deleteFormElement" src="' + smartFormsRootPath + 'images/delete.png" title="Delete"/></div>');
        var self = this;
