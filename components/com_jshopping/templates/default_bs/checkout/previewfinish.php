...
<div class="jshop prevfinish_info">
   ...
   <div class="addr_block">
      ...
      <div class="shipping_method">
         ...
         <div class="delivery_time">
            <strong><?php echo _JSHOP_DELIVERY_TIME?></strong>: <?php print $this->delivery_time?>
         </div>
         <?php }?>

         <?php if ($this->delivery_date){?>
         <div class="delivery_date">
            <strong><?php echo _JSHOP_DELIVERY_DATE?></strong>: <?php print $this->delivery_date?>
         </div>
         <?php }?>       
      </div>
      <?php } ?>
   ...
   <form name="form_finish" action="<?php print $this->action ?>" method="post">
   	<div class="prevfinishjshop">
   		...
   		<div class="checkbox inline row_agb">            
   		...
   		<div class="finish_registration">
   			<input class="btn btn-success" type="submit" name="finish_registration" value="<?php print _JSHOP_ORDER_FINISH?>" <?php if ($this->config->display_agb){?>onclick="return checkAGB()"<?php }?> />
   		</div>
   	</div>
