...
?>
    ...
    <form class="form-horizontal" action="<?php print $this->action ?>" method="post" name="loginForm" onsubmit="return validateEditAccountForm('<?php print $this->live_path ?>', this.name)">
    ...
    <div class="control-group">
   <label class="control-label"> <?php echo _JSHOP_DELIVERY_ADRESS ?></label>
    <div class="controls">
    
    <label class="radio inline" for="delivery_adress_1"><?php echo _JSHOP_NO ?></label>
    ...
    <label class="radio inline" for="delivery_adress_2"><?php echo _JSHOP_YES ?></label>
