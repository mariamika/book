...
//        $module_id = $this->module_id;
        ...
        if (sizeof($cis_options) > 0) {
            ...
            $slidereffect = $cis_options_value->slider_list_effects_s;
        ...
        <!--<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.1/jquery.min.js"></script>-->
            <?php if ($hasvimeo == true) { ?>
                <script src="<?php echo JURI::root() . 'media/com_slider/js/vimeo.lib.js' ?>"></script>
                <script>
                    jQuery(function () {
            ...
            <?php if ($hasyoutube == true) { ?>
                <script src="<?php echo JURI::root() . 'media/com_slider/js/youtube.lib.js' ?>"></script>
                <script>
                <?php
...
//		$recent_posts = wp_get_recent_posts( $args, ARRAY_A );
            ...
            //			stopYoutubeVideo();
                ...
                function huge_it_popup_resize_<?php echo $sliderID; ?>() {
                    ...
                    if ("<?php echo $slideshow_title_position[1]; ?>" == "middle") {
                        var titlemargintopminus = jQuery(".huge_it_slideshow_title_text_<?php echo $sliderID; ?>").outerHeight() / 2;
                    }
                    if ("<?php echo $slideshow_title_position[0]; ?>" == "center") {
                        var titlemarginleftminus = jQuery(".huge_it_slideshow_title_text_<?php echo $sliderID; ?>").outerWidth() / 2;
                    }
                    ...
                    if ("<?php echo $slideshow_description_position[1]; ?>" == "middle") {
                        var descriptionmargintopminus = jQuery(".huge_it_slideshow_description_text_<?php echo $sliderID; ?>").outerHeight() / 2;
                    }
                    if ("<?php echo $slideshow_description_position[0]; ?>" == "center") {
                        var descriptionmarginleftminus = jQuery(".huge_it_slideshow_description_text_<?php echo $sliderID; ?>").outerWidth() / 2;
                    }
                    ...
                    if ("<?php echo $paramssld['slider_crop_image']; ?>" == "resize") {
                        jQuery(".huge_it_slideshow_image_<?php echo $sliderID; ?>, .huge_it_slideshow_image_item1_<?php echo $sliderID; ?> img, .huge_it_slideshow_image_container_<?php echo $sliderID; ?> img").css({
                            cssText: "width:" + sliderwidth + "px; height:" + ((sliderwidth) * str) + "px;"
                        });
                    } else {
                        jQuery(".huge_it_slideshow_image_<?php echo $sliderID; ?>,.huge_it_slideshow_image_item1_<?php echo $sliderID; ?>,.huge_it_slideshow_image_item2_<?php echo $sliderID; ?>").css({
            ...
            ?>;
                ...
                .huge_it_slideshow_image_item1_<?php echo $sliderID; ?> {
                    display: table; 
                    width: inherit; 
                    height: inherit;
                }
                .huge_it_slideshow_image_item2_<?php echo $sliderID; ?> {
                    display: table-cell; 
                    vertical-align: middle; 
                    text-align: center;
                }

                .huge_it_slideshow_image_item2_<?php echo $sliderID; ?> a {
                    display:block;
                    vertical-align:middle;
                    width:100%;
                    height:100%;
            ...
            <?php
            $arrowfolder = JURI::root() . 'media/com_slider/images/Front_images/arrows';
                ...
                case 1:
                    ?>
                        #huge_it_slideshow_left_<?php echo $sliderID; ?> {	
                            ...
                            height:43px;
                            width:29px;
                            background:url(<?php echo $arrowfolder; ?>/arrow-point-to-left.svg) left  top no-repeat; 
                        }
                        ...
                        #huge_it_slideshow_right_<?php echo $sliderID; ?> {
                            ...
                            height:43px;
                            width:29px;
                            background:url(<?php echo $arrowfolder; ?>/arrow-point-to-right.svg) right top no-repeat; 
                        }
                    <?php
                    break;
                case 2:
            ...
            <div class="huge_it_slideshow_image_wrap_<?php echo $sliderID; ?>">
                ...
                <div class="huge_it_slideshow_dots_container_<?php echo $sliderID; ?>">
                        ...
                        foreach ($images as $key => $image_row) {
                            ...
                            switch ($imagerowstype) {
                                ...
                                case 'image':
                                    ...
                                    ?>
                                    <div id="huge_it_dots_<?php echo $stri; ?>_<?php echo $sliderID; ?>" class="huge_it_slideshow_dots_<?php echo $sliderID; ?> <?php echo (($key == $current_image_id) ? 'huge_it_slideshow_dots_active_' . $sliderID : 'huge_it_slideshow_dots_deactive_' . $sliderID); ?>" onclick="huge_it_change_image_<?php echo $sliderID; ?>(parseInt(jQuery('#huge_it_current_image_key_<?php echo $sliderID; ?>').val()), '<?php echo $stri; ?>', data_<?php echo $sliderID; ?>, false, true);
                    ...
                    case 'last_posts':
                            ...
                            if ($lkeys < $image_row->sl_url) {
                                ...
                                ?>
                                    ...
                                    if ($paramssld['slider_show_arrows'] == "on") {
                                        ?>
                        <a id="huge_it_slideshow_left_<?php echo $sliderID; ?>" href="#" onclick="huge_it_change_image_<?php echo $sliderID; ?>(parseInt(jQuery('#huge_it_current_image_key_<?php echo $sliderID; ?>').val()), (parseInt(jQuery('#huge_it_current_image_key_<?php echo $sliderID; ?>').val()) - iterator_<?php echo $sliderID; ?>()) >= 0 ? (parseInt(jQuery('#huge_it_current_image_key_<?php echo $sliderID; ?>').val()) - iterator_<?php echo $sliderID; ?>()) % data_<?php echo $sliderID; ?>.length : data_<?php echo $sliderID; ?>.length - 1, data_<?php echo $sliderID; ?>, false, true);
                                                        return false;">
                        ...
                        <a id="huge_it_slideshow_right_<?php echo $sliderID; ?>" href="#" onclick="huge_it_change_image_<?php echo $sliderID; ?>(parseInt(jQuery('#huge_it_current_image_key_<?php echo $sliderID; ?>').val()), (parseInt(jQuery('#huge_it_current_image_key_<?php echo $sliderID; ?>').val()) + iterator_<?php echo $sliderID; ?>()) % data_<?php echo $sliderID; ?>.length, data_<?php echo $sliderID; ?>, false, true);
                                                        return false;">
                ...
                <div id="huge_it_slideshow_image_container_<?php echo $sliderID; ?>" class="huge_it_slideshow_image_container_<?php echo $sliderID; ?>">        
                    ...
                    <div class="huge_it_slide_container_<?php echo $sliderID; ?>">
                        <div class="huge_it_slide_bg_<?php echo $sliderID; ?>">
                            ...
                            $current_key = $key;
                            echo '_second';
                        } ?>_item_<?php echo $sliderID; ?>" id="image_id_<?php echo $sliderID . '_' . $i ?>">      
                                            <?php
                                            if ($image_row->sl_url != "") {
                            ...
                            echo '</a>';
                                    ...
                                    <?php if ($image_row->sl_postlink == "1") {
                                        echo '</a>';
                                                            ...
                                                            <div class="huge_it_slideshow_title_text_<?php echo $sliderID; ?> <?php if (trim($last_posts["post_title"]) == "") echo "none";
                                    if ($image_row->sl_stitle != "1") echo " hidden"; ?>">
                                    <?php echo $last_posts["post_title"]; ?>
                                                            </div>
                                                            <div class="huge_it_slideshow_description_text_<?php echo $sliderID; ?> <?php if (trim($last_posts["post_content"]) == "") echo "none";
